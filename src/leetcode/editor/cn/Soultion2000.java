...
public class Soultion2000 {
    public static void main(String[] args) {
        Solution solution = new Soultion2000().new Solution();
    }
...
class Solution {
    public String reversePrefix(String word, char ch) {
        ...
        StringBuilder sb = new StringBuilder(word.substring(0,first + 1));
        sb.reverse().append(word.substring(first + 1));
        return sb.toString();
    }
}
